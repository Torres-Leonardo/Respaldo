...
public class AccesoDB {
	...
	public static Connection getConnection() throws SQLException {
		...
		String urlDB = "jdbc:sqlserver://localhost:1433;databaseName=NOTASREGISTRO";
		String user = "sa";
		String pass = "@abc123@";
		try {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Sí conectó GestiónNotas.");
			cn.close();
		} catch (Exception e) {
			System.out.println("No conectó GestiónNotas.");
			e.printStackTrace();
		}
	}
}